...
./.venv/bin/robot \
  ...
  --variable WAN_NET:${WAN_NET} --variable WAN_PREFIX:${WAN_PREFIX} \
  --variable R1_WAN_IP:${R1_WAN_IP} --variable R2_WAN_IP:${R2_WAN_IP} --variable R3_WAN_IP:${R3_WAN_IP} \
  --variable R2_HUB_INTF:${R2_HUB_INTF}     --variable R3_HUB_INTF:${R3_HUB_INTF} \
  --variable DMVPN_TUNNEL:${DMVPN_TUNNEL} --variable DMVPN_NET:${DMVPN_NET} \
  --variable NHRP_NETWORK_ID:${NHRP_NETWORK_ID} --variable NHRP_AUTH:${NHRP_AUTH} \
  --variable R1_DMVPN_IP:${R1_DMVPN_IP} --variable R2_DMVPN_IP:${R2_DMVPN_IP} --variable R3_DMVPN_IP:${R3_DMVPN_IP} \
  --variable R2_TUNNEL_HUB:${R1_DMVPN_IP} --variable R2_TUNNEL_LOCAL:${R2_DMVPN_IP} \
  --variable R3_TUNNEL_HUB:${R1_DMVPN_IP} --variable R3_TUNNEL_LOCAL:${R3_DMVPN_IP} \
